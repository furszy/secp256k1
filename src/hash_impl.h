...
static void secp256k1_sha256_write(secp256k1_sha256 *hash, const unsigned char *data, size_t len, secp256k1_fn_sha256_transform fn_transform) {
...
static void secp256k1_sha256_finalize(secp256k1_sha256 *hash, unsigned char *out32, secp256k1_fn_sha256_transform fn_transform) {
    ...
    secp256k1_sha256_write(hash, pad, 1 + ((119 - (hash->bytes % 64)) % 64), fn_transform);
    secp256k1_sha256_write(hash, sizedesc, 8, fn_transform);
    for (i = 0; i < 8; i++) {
...
static void secp256k1_sha256_initialize_tagged(secp256k1_sha256 *hash, const unsigned char *tag, size_t taglen, secp256k1_fn_sha256_transform fn_sha256_transform) {
    ...
    secp256k1_sha256_write(hash, tag, taglen, fn_sha256_transform);
    secp256k1_sha256_finalize(hash, buf, fn_sha256_transform);

    secp256k1_sha256_initialize(hash);
    secp256k1_sha256_write(hash, buf, 32, fn_sha256_transform);
    secp256k1_sha256_write(hash, buf, 32, fn_sha256_transform);
}
...
static void secp256k1_hmac_sha256_initialize(secp256k1_hmac_sha256 *hash, const unsigned char *key, size_t keylen, secp256k1_fn_sha256_transform fn_sha256_transform) {
    ...
    if (keylen <= sizeof(rkey)) {
        ...
        secp256k1_sha256_write(&sha256, key, keylen, fn_sha256_transform);
        secp256k1_sha256_finalize(&sha256, rkey, fn_sha256_transform);
        memset(rkey + 32, 0, 32);
    }
    ...
    secp256k1_sha256_write(&hash->outer, rkey, sizeof(rkey), fn_sha256_transform);

    secp256k1_sha256_initialize(&hash->inner);
    for (n = 0; n < sizeof(rkey); n++) {
        rkey[n] ^= 0x5c ^ 0x36;
    }
    secp256k1_sha256_write(&hash->inner, rkey, sizeof(rkey), fn_sha256_transform);
    secp256k1_memclear_explicit(rkey, sizeof(rkey));
}

static void secp256k1_hmac_sha256_write(secp256k1_hmac_sha256 *hash, const unsigned char *data, size_t size, secp256k1_fn_sha256_transform fn_sha256_transform) {
    secp256k1_sha256_write(&hash->inner, data, size, fn_sha256_transform);
}

static void secp256k1_hmac_sha256_finalize(secp256k1_hmac_sha256 *hash, unsigned char *out32, secp256k1_fn_sha256_transform fn_sha256_transform) {
    unsigned char temp[32];
    secp256k1_sha256_finalize(&hash->inner, temp, fn_sha256_transform);
    secp256k1_sha256_write(&hash->outer, temp, 32, fn_sha256_transform);
    secp256k1_memclear_explicit(temp, sizeof(temp));
    secp256k1_sha256_finalize(&hash->outer, out32, fn_sha256_transform);
}
...
static void secp256k1_rfc6979_hmac_sha256_initialize(secp256k1_rfc6979_hmac_sha256 *rng, const unsigned char *key, size_t keylen, secp256k1_fn_sha256_transform fn_sha256_transform) {
    ...
    secp256k1_hmac_sha256_write(&hmac, rng->v, 32, fn_sha256_transform);
    secp256k1_hmac_sha256_write(&hmac, zero, 1, fn_sha256_transform);
    secp256k1_hmac_sha256_write(&hmac, key, keylen, fn_sha256_transform);
    secp256k1_hmac_sha256_finalize(&hmac, rng->k, fn_sha256_transform);
    secp256k1_hmac_sha256_initialize(&hmac, rng->k, 32, fn_sha256_transform);
    secp256k1_hmac_sha256_write(&hmac, rng->v, 32, fn_sha256_transform);
    secp256k1_hmac_sha256_finalize(&hmac, rng->v, fn_sha256_transform);

    /* RFC6979 3.2.f. */
    secp256k1_hmac_sha256_initialize(&hmac, rng->k, 32, fn_sha256_transform);
    secp256k1_hmac_sha256_write(&hmac, rng->v, 32,fn_sha256_transform);
    secp256k1_hmac_sha256_write(&hmac, one, 1, fn_sha256_transform);
    secp256k1_hmac_sha256_write(&hmac, key, keylen, fn_sha256_transform);
    secp256k1_hmac_sha256_finalize(&hmac, rng->k, fn_sha256_transform);
    secp256k1_hmac_sha256_initialize(&hmac, rng->k, 32, fn_sha256_transform);
    secp256k1_hmac_sha256_write(&hmac, rng->v, 32, fn_sha256_transform);
