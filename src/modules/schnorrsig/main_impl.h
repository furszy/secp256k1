...
static int nonce_function_bip340_impl(const secp256k1_context *ctx, unsigned char *nonce32, const unsigned char *msg, size_t msglen, const unsigned char *key32, const unsigned char *xonly_pk32, const unsigned char *algo, size_t algolen, void *data) {
    ...
    if (data != NULL) {
        ...
        secp256k1_sha256_write(&sha, data, 32, ctx->hash_context.fn_sha256_transform);
        secp256k1_sha256_finalize(&sha, masked_key, ctx->hash_context.fn_sha256_transform);
        for (i = 0; i < 32; i++) {
    ...
    secp256k1_sha256_write(&sha, masked_key, 32, ctx->hash_context.fn_sha256_transform);
    secp256k1_sha256_write(&sha, xonly_pk32, 32, ctx->hash_context.fn_sha256_transform);
    secp256k1_sha256_write(&sha, msg, msglen, ctx->hash_context.fn_sha256_transform);
    secp256k1_sha256_finalize(&sha, nonce32, ctx->hash_context.fn_sha256_transform);
...
static void secp256k1_schnorrsig_challenge(const secp256k1_context *ctx, secp256k1_scalar* e, const unsigned char *r32, const unsigned char *msg, size_t msglen, const unsigned char *pubkey32)
{
    ...
    secp256k1_sha256_write(&sha, r32, 32, ctx->hash_context.fn_sha256_transform);
    secp256k1_sha256_write(&sha, pubkey32, 32, ctx->hash_context.fn_sha256_transform);
    secp256k1_sha256_write(&sha, msg, msglen, ctx->hash_context.fn_sha256_transform);
    secp256k1_sha256_finalize(&sha, buf, ctx->hash_context.fn_sha256_transform);
...
static int secp256k1_schnorrsig_sign_internal(const secp256k1_context* ctx, unsigned char *sig64, const unsigned char *msg, size_t msglen, const secp256k1_keypair *keypair, secp256k1_nonce_function_hardened noncefp, void *ndata) {
    ...
    if (noncefp == NULL || noncefp == secp256k1_nonce_function_bip340) {
        if (ctx->hash_context.fn_sha256_transform != NULL) {
            ...
            ret &= secp256k1_nonce_function_bip340(nonce32, msg, msglen, seckey, pk_buf, bip340_algo, sizeof(bip340_algo), ndata);
        }
    } else {
