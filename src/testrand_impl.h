...
SECP256K1_INLINE static void testrand_seed(const unsigned char *seed16) {
    ...
    secp256k1_sha256_write(&hash, PREFIX, sizeof(PREFIX), secp256k1_get_sha256_transform(ctx));
    secp256k1_sha256_write(&hash, seed16, 16, secp256k1_get_sha256_transform(ctx));
