...
SECP256K1_INLINE static void testrand_seed(const unsigned char *seed16) {
    ...
    secp256k1_sha256_write(&hash, PREFIX, sizeof(PREFIX), ctx->hash_context.fn_sha256_transform);
    secp256k1_sha256_write(&hash, seed16, 16, ctx->hash_context.fn_sha256_transform);
