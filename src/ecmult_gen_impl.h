...
static void secp256k1_ecmult_gen_context_build(secp256k1_ecmult_gen_context *ctx, secp256k1_fn_sha256_transform fn_transform) {
    secp256k1_ecmult_gen_blind(ctx, NULL, fn_transform);
    ctx->built = 1;
}
...
static void secp256k1_ecmult_gen_blind(secp256k1_ecmult_gen_context *ctx, const unsigned char *seed32, secp256k1_fn_sha256_transform fn_sha256_transform) {
    secp256k1_scalar b;
