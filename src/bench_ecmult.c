...
static void generate_scalar(const secp256k1_context *ctx, uint32_t num, secp256k1_scalar* scalar) {
    ...
    secp256k1_sha256_write(&sha256, c, sizeof(c), ctx->hash_context.fn_sha256_transform);
    secp256k1_sha256_finalize(&sha256, buf, ctx->hash_context.fn_sha256_transform);
