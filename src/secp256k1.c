...
void secp256k1_context_set_sha256_transform_callback(secp256k1_context *ctx, void (*sha256_transform_callback_)(uint32_t *state, const unsigned char *msg, size_t rounds)) {
    VERIFY_CHECK(ctx != NULL);
