...
secp256k1_context* secp256k1_context_preallocated_create(void* prealloc, unsigned int flags) {
    ...
    secp256k1_ecmult_gen_context_build(&ret->ecmult_gen_ctx, ret->hash_context.fn_sha256_transform);
...
static SECP256K1_INLINE secp256k1_fn_sha256_transform secp256k1_get_sha256_transform(const secp256k1_context *ctx) {
    return ctx->hash_context.fn_sha256_transform;
}
...
static int nonce_function_rfc6979_impl(const secp256k1_context *ctx, unsigned char *nonce32, const unsigned char *msg32, const unsigned char *key32, const unsigned char *algo16, void *data, unsigned int counter) {
   ...
   secp256k1_rfc6979_hmac_sha256_initialize(&rng, keydata, offset, secp256k1_get_sha256_transform(ctx));
   for (i = 0; i <= counter; i++) {
       secp256k1_rfc6979_hmac_sha256_generate(&rng, nonce32, 32, secp256k1_get_sha256_transform(ctx));
   }
...
int secp256k1_tagged_sha256(const secp256k1_context* ctx, unsigned char *hash32, const unsigned char *tag, size_t taglen, const unsigned char *msg, size_t msglen) {
    ...
    secp256k1_sha256_write(&sha, msg, msglen, secp256k1_get_sha256_transform(ctx));
    secp256k1_sha256_finalize(&sha, hash32, secp256k1_get_sha256_transform(ctx));
